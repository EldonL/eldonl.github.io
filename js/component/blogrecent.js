    ...
    <div class="blogclass">
        ...
        <div class="filterblog">
            <div class="blogcontent">
                <a href="blogfirstandroidgame24.html"><img class="image" src="images_videos/blog/FirstAndroidGame/photonfusion.jpg"
                alt="cover image"></a>
                <div class="imagetext">Click to see more</div>
                <div class="bottom">
                    <p class="title">First Android Game - Part 24 - Photon Fusion</p>
                </div>
            </div>
        </div>        
        <div class="filterblog">
            <div class="blogcontent">
                <a href="blogfirstandroidgame23.html"><img class="image" src="images_videos/blog/FirstAndroidGame/firebase51.PNG"
                alt="cover image"></a>
                <div class="imagetext">Click to see more</div>
                <div class="bottom">
                    <p class="title">First Android Game - Part 23 - Firebase APIs</p>
                </div>
            </div>
        </div>        
        <div class="filterblog">
            <div class="blogcontent">
                <a href="blogfirstandroidgame22.html"><img class="image" src="images_videos/blog/FirstAndroidGame/firebase0.PNG"
                alt="cover image"></a>
                <div class="imagetext">Click to see more</div>
                <div class="bottom">
                    <p class="title">First Android Game - Part 22 - Firebase</p>
                </div>
            </div>
        </div>        
        <div class="filterblog">
        ...
        <div class="filterblog">
            ...
            <div class="filterblog">
                <div class="blogcontent">
                    <a href="test.html"><img class="image" src="images_videos/blog/FirstAndroidGame/coverimage.png"
                        alt="cover image"></a>
                    <div class="imagetext">Click to see more</div>
                    <div class="bottom">
